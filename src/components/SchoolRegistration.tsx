      ...
      <div className="w-full max-w-md bg-white rounded-[2.5rem] shadow-xl overflow-hidden mt-12">
        ...
        <div className="p-8">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1">
              <label className="block text-xs font-bold text-slate-400 uppercase tracking-widest ml-1">{t('auth.phone')}</label>
              <div className="relative">
            ...
            <div className="space-y-1">
              <label className="block text-xs font-bold text-slate-400 uppercase tracking-widest ml-1">{t('auth.greeting')}</label>
              <div className="relative">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  placeholder={t('auth.greeting_placeholder')}
                  rows={3}
                  className="w-full pl-12 pr-4 py-3 bg-slate-50 border border-slate-100 rounded-2xl focus:outline-none focus:ring-2 focus:ring-orange-500/20 font-medium transition-all resize-none"
                />
              </div>
            </div>
